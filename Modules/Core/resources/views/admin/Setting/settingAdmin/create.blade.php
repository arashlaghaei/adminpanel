...
@section('content')
    ...
    <form method="post" action="{{route('web.admin.setting.admin.index')}}">
        {{ csrf_field() }}
        <div class="row white z-depth-1">
            ...
            <div class="col-md-6">
                ...
                'options'=>['string'=>'string','file'=>'file','boolean'=>'boolean','textarea'=>'textarea','editor'=>'editor','movie'=>'movie','movieSingle'=>'movieSingle','category'=>'category','category'=>'categorySingle','series'=>'series','seriesSingle'=>'seriesSingle']])
            </div>
