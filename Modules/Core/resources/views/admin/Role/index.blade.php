    ...
    <x-slot name="table">
        ...
        <thead>
            <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                ...
                <th class="min-w-125px">نام دسترسی</th>
                <th class="min-w-125px">تعداد مجوز‌ها</th>
        ...
        <tbody class="fw-semibold text-gray-600">
            <tr v-if="itemList.length > 0" v-for="item in itemList">
                ...
                <td>
                    <p v-text="item.name" class="text-gray-800 text-hover-primary mb-1"></p>
                </td>
                <td>
                    <p v-text="item.permissions_count" class="text-gray-800 text-hover-primary mb-1"></p>
                </td>
                <td>
                    <p v-text="toPersian(item.created_at)" class="ltr text-start"></p>
                </td>
                <td class="text-end">
